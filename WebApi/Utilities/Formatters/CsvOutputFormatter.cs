...
namespace WebApi.Utilities.Formatters
{
    public class CsvOutputFormatter : TextOutputFormatter
    {
        ...
        {
            SupportedMediaTypes.Add(MediaTypeHeaderValue.Parse("text/csv"));  // Microsoft
        ...
        {
            if(typeof(BookDto).IsAssignableFrom(type) || typeof(IEnumerable<BookDto>).IsAssignableFrom(type))   // Support List - Support Singular
            {
